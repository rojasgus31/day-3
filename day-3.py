...
def get_neighbors(x, y, rows, cols):
    """Return the coordinates of the neighbors of a cell (x, y)."""
    directions = list(product([-1, 0, 1], repeat=2))
    directions.remove((0, 0))  # Excluyendo la celda en si
    neighbors = []
...
def solve_puzzle(data):
    ...
    for x in range(rows):
        for y in range(cols):
            ...
            if cell.isdigit():
                num = int(cell)
                if any(is_symbol(grid[nx, ny]) for nx, ny in get_neighbors(x, y, rows, cols)):
                    total_sum += num
                    
    return total_sum

data = """..............423....688..934............970................................95.728..........896...113..................153..972.............
...122..................*.....*..........................919..509*..........&...@.........../...........................+.......*...........
